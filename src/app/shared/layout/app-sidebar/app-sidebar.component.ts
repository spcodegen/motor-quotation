...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><image href="/images/icons/car-side-2.svg" width="24" height="24" /></svg>`,
      name: "Motor Quotation",
      path: "/motor-quotation-list",
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><image href="/images/icons/car.svg" width="24" height="24" /></svg>`,
      name: "Vehicle Make",
      path: "/vehicle-make-list",
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><image href="/images/icons/car-side-1.svg" width="24" height="24" /></svg>`,
      name: "Vehicle Model",
